...
import Coelhao from "../../../imagens/coelhao.png"
                        ...
                        <CardWrapper>
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <ContainerInput>
                                        <InputName 
                                            type="text" placeholder="Preço do produto"
                                            value={productPrice}
                                ...
                                <CardContent>
                                    ...
                                    <ContainerInput>
                                        <InputName 
                                            ...
                                            value={productLocate}
                                            onChange={(e)=> setProductLocate(e.target.value)}
                                        />
                                        <TextInput>
                                            <IoEarth2></IoEarth2>
						                </TextInput>
                        ...
                        <CardWrapper>
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    />
                                    <LabelImage htmlFor="file"><IoImage2></IoImage2></LabelImage>
                                    <Writer>
                                        {/* Style will be inherited from the parent element */}
                                        <Typewriter
                                            loop={5}
